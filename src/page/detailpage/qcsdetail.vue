<template>
  <section class="detail" id="detail">
    ...
    <!--产品详情（底部）-->
    <qcsDetailFooter :productId="product_info.productId" :typeUser="product_info.type_user" :ZIndex="zIndex" :InfoList="mys_info.infoList" @contStar="getProduct" @followTips="showFollowTips"></qcsDetailFooter>
  </section>
</template>
<script>
...
import qcsDetailFooter from './children/qcsDetailFooter';
