  ...
  <section class="detail" id="detail">
    <div class="main" v-if="!pingjiaShow">
      ...
      <!-- 订购须知 -->
       ...
       <div style="display:none" class="orderInfo">
      ...
      <div class="orderInfo" v-if="isshowcont">
          <div class="title clear">

          </div>
          <ul class="content">
              <li>1、服务对象：屈臣氏工会会员</li>
              <li>2、服务时间：即日起至2019年4月30日</li>
              <li>3、服务内容：屈臣氏到店服务由俏猫平台签约美业师为您全力打造亮丽的妆容</li>
              <li>4、优惠说明：下单前您需输入屈臣氏福利卡背面的尊享码兑换298元抵扣券(单张卡不可重复使用)，下单时选择抵扣券支付即可0元享受服务</li>
              <li>5、因消防安全问题部分门店将无法提供卷发造型服务，如有特殊需求请在下单时添加备注</li>
              <li>6、门店正常服务时间为：10:00-20:00(具体时间可在下单时选择对应门店查看)</li>
              <li>7、订单确认后，出示预约成功的订单信息在选择的时间段和门店享受服务并进行核销。预约成功后如需修改订单请提前3小时联系客服</li>
              <li>8、如有问题咨询请拨打客服电话: 400-8335-138</li>
            <p> 一最终解释权归俏猫所有一</p>
          </ul>
      </div>
      <!--机构个人自营-->
    ...
    <!--产品详情（底部）-->
    <goShopDetailFooter :productId="product_info.productId" :typeUser="product_info.type_user" :ZIndex="zIndex" :InfoList="mys_info.infoList" @contStar="getProduct" @followTips="showFollowTips"></goShopDetailFooter>
  </section>
</template>
<script>
...
import goShopDetailFooter from './children/goShopDetailFooter';
...
export default {
  ...
  created() {
    ...
    if(this.$route.query.id == 1000069){
