        ...
        <mt-tab-container-item id="service_items" class="product_list">
          ...
          <mt-navbar v-model="selecte">
            ...
            <div v-for="(item,index) in severlist" :key="index" class="look_item">
              <a :href=" shoppingId ? `/shopservicedetail/${item.id}?stylist_id=${shoppingId}` : `/shopservicedetail/${item.id}`">
                <div class="look_part">
                  <div class="item_img">
                    <!-- <img v-lazy="list.images ? list.images : '../../../assets/image/img/detail/square_default_bg.jpg'" > -->
                    <!-- :style="{backgroundImage : 'url('+myimgs+')'}" -->
                    <div class="img_box" >
                      <a class="product_img" :href=" shoppingId ? `/shopservicedetail/${item.id}?stylist_id=${shoppingId}` : `/shopservicedetail/${item.id}`">
