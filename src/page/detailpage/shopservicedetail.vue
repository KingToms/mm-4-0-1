  ...
  <section class="detail" id="detail">
    <div class="main" v-if="!pingjiaShow">
      ...
      <!-- 订购须知 -->
       ...
       <div class="orderInfo" v-if="isshowrule" style="display:none">
    ...
    <!--产品详情（底部）-->
    <serviceDetailFooter :productId="product_info.productId" :typeUser="product_info.type_user" :ZIndex="zIndex" :InfoList="mys_info.infoList" @contStar="getProduct" @followTips="showFollowTips"></serviceDetailFooter>
  </section>
</template>
<script>
...
import serviceDetailFooter from './children/serviceDetailFooter';
